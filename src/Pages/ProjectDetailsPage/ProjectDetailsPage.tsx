      ...
      <Grid container spacing={2} direction="row" style={{ margin: "2%" }}>
          ...
          <Grid container direction="column" spacing={2}>
            <Grid item xs={2}>
              ...
              <Grid
                ...
                alignItems="center"
              >
                <Grid item xs={4} style={{ marginRight: -50, marginTop: 25 }}>
                  <PersonIcon style={{ color: "#ef476f" }}></PersonIcon>
                </Grid>
                <Grid item xs={8}>
                  <p>Jane Doe</p>
                </Grid>
            ...
            <Grid item xs={2}>
              ...
              >
                <Grid item xs={4} style={{ marginRight: -50, marginTop: 25 }}>
                  <PersonIcon style={{ color: "#06d6a0" }}></PersonIcon>
                </Grid>
                <Grid item xs={8}>
                  <p>Jane Doe</p>
                </Grid>
        ...
        <Grid item xs={6}>
          ...
          <Grid container direction="row" spacing={4} justifyContent="center" alignItems="center">
            <Grid item xs={2}>
              <TimerIcon style={{ color: "#ffd166" }}></TimerIcon>
            </Grid>
            <Grid item xs={8}>
            ...
            <Grid item xs={2}>
              <PercentIcon style={{ color: "#ffd166" }}></PercentIcon>
            </Grid>
            <Grid item xs={8}>
